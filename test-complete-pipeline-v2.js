...
async function testCompletePipeline() {
    ...
    const sessionTempPath = path.join('/tmp/health-reports', sessionId);
    ...
    try {
        ...
        // Step 2: Create mock screenshot files (valid PNG format)
        ...
        // Create valid PNG files (1x1 pixel PNG)
        ...
        // Step 3: Call OpenAI Analysis Service
        ...
        // Mock screenshot metadata matching what was captured
        ...
        const screenshotsArray = screenshots.map(filename => {
            const filePath = path.join(sessionTempPath, filename);
        ...
        // Check file size
        const docStats = fsSync.statSync(docPath);
